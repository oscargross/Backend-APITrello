...
exports.deleteCard = exports.readCards = exports.updateCard = exports.createCard = void 0;
...
var createCard = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                nameList = req.query.nameList;
                info = req.body;
                return [4 /*yield*/, cardUtils_1.findField({ nameField: nameList, field: 'lists' })
                        .then(function (list) {
                        var idList = list.id;
                        var fields = __assign(__assign({}, info), { idList: idList });
...
var readCards = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var nameCard;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
